...
# Read dataset and change formats to Date end Numeric
...
plot(x=data1$Datetime, y=data1$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(x=data1$Datetime, y=data1$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()